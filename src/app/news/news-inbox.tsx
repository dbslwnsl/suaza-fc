...
const TYPE_BADGE: Record<string, { char: string; color: string }> = {
  ...
  like: { char: "좋", color: "#EC4899" },
  match_schedule: { char: "일", color: "#22C55E" },
  team_change: { char: "팀", color: "#6366F1" },
  coach_note: { char: "감", color: "#1D2E3E" },
  match_comment: { char: "댓", color: "#0EA5E9" },
  match_comment_like: { char: "좋", color: "#EC4899" },
  coach_comment: { char: "코", color: "#E11D48" },
  coach_comment_like: { char: "좋", color: "#EC4899" },
...
const CATEGORY_OF: Record<string, Category> = {
  ...
  coach_note: "match",
  match_comment: "match",
  match_comment_like: "match",
  coach_comment: "match",
  coach_comment_like: "match",
  new_member: "club",
  points: "club",
  signup_pending: "club",
};
